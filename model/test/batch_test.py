...
def make_batch_and_order_line(
    ...
    batch = Batch(reference="batch-1", sku=batch_sku, quantity=batch_quantity)
    order_line = OrderLine(
        order_reference="order-1", sku=line_sku, quantity=line_quantity
    )
...
def test_allocate_different_order_lines_to_batch_reduces_available_quantity():
    ...
    order_line3 = OrderLine(order_reference="order-2", sku="TEST-SKU", quantity=5)
